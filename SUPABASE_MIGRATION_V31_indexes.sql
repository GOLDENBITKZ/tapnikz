...
CREATE INDEX CONCURRENTLY IF NOT EXISTS click_events_link_created_idx
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS profiles_updated_at_idx
  ON public.profiles (updated_at DESC);

-- 3. Index on profiles.view_count DESC
--    Covers discover page: ORDER BY view_count DESC LIMIT 48
CREATE INDEX CONCURRENTLY IF NOT EXISTS profiles_view_count_idx
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS payments_pending_autovalidated_idx
