    ...
    items: [
      {
        ...
        a: [
          'Это короткий адрес из эмодзи или символов, который ведёт куда вы укажете — например tapni.kz/🚀 открывает ваш Instagram или сайт.',
          'Один символ занимает только один человек во всём сервисе — как никнейм, только короче и заметнее.',
          'Каждая забронированная ссылка сразу работает по двум адресам: tapni.kz/🚀 и tapni.kz/tapni.kz/🚀.',
          'Удобно для визиток, вывесок и рекламы: такой адрес легко продиктовать и запомнить.',
        ],
      },
      {
        q: 'Какие бывают категории и чем отличаются?',
        a: [
          '👑 VIP Single Emoji — один символ (tapni.kz/🚀). Самый редкий формат: таких вариантов около 1 800 на весь сервис.',
          '⚡ Double Emoji — два символа (tapni.kz/🚀🔥). Примерно 3,2 млн сочетаний.',
          '🟢 Combo / Custom — текст, эмодзи или их сочетание (tapni.kz/go🚀, tapni.kz/moy-magazin).',
