    ...
    items: [
      ...
      },
      {
        ...
        a: [
          ...
          '🟢 Combo / Custom — текст, эмодзи или их сочетание (tapni.kz/go🚀). До 5 символов.',
          'Максимальная длина любой ссылки — 5 символов, чтобы адрес оставался коротким.',
        ],
      },
      {
      ...
      },
      {
        ...
        a: [
          ...
          '«Максимум 5 символов» — сократите ссылку.',
        ],
      },
      {
