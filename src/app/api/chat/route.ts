...
ЭМОДЗИ-ССЫЛКИ «ЗАСТОЛБИТЬ СИМВОЛ» (только Premium):
Короткий адрес из слова и эмодзи, ведущий куда укажет пользователь: tapni.kz/bizde😅
ОБЯЗАТЕЛЬНО нужно слово (латиница/цифры). Только эмодзи занять НЕЛЬЗЯ — иначе первый занявший 🚀 забрал бы символ навсегда и остальным он стал бы недоступен. Со словом вариантов бесконечно: shop🚀, cafe🚀, bizde🚀 сосуществуют.
Примеры: tapni.kz/bizde😅, tapni.kz/shop🚀, tapni.kz/cafe☕, tapni.kz/moy-magazin
Максимум 32 символа — можно и одно слово, и целое имя. Кириллица запрещена (защита от поддельных ссылок), латиница и эмодзи разрешены.
Где: кабинет → вкладка «Профиль» → блок «Застолбить эмодзи-ссылку». Есть выбор эмодзи из списка, проверка занятости на лету и кнопка «Скопировать ссылку» для вставки в Instagram.
На аккаунт — одна ссылка. Её можно освободить кнопкой и занять другую.
Адрес назначения можно менять сколько угодно (нужен активный Premium), сам символ остаётся навсегда и продолжает работать даже после окончания подписки.
Нельзя занять служебные слова (dashboard, pay, api, kaspi, halyk, названия городов и т.п.).

ПРОФИЛЬ: имя бизнеса (можно с эмодзи — в поле есть выбор эмодзи и готовые варианты вроде «☕ Кофейня»), описание (bio), адрес, рабочие часы, аватар, 6 тем (Тёмная, Светлая, Градиент, Блогер, Бизнес, Продавец)
...
Premium месяц: 1 000 ₸/мес — безлимит кнопок, все типы кнопок, эмодзи-ссылка (застолбить символ), QR-код, аналитика, смена ника, без водяного знака
